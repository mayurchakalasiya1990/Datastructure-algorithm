...
public class ChildSumPropertyForTree {
    ...
    {
        org.dsf.tree.Node root=new org.dsf.tree.Node(20);
        root.left=new org.dsf.tree.Node(8);
        root.right=new org.dsf.tree.Node(12);
        root.right.left=new org.dsf.tree.Node(3);
        root.right.right=new org.dsf.tree.Node(9);

        System.out.print(isCSum(root));
    }

    public static boolean isCSum(org.dsf.tree.Node root) {
        if (root == null)
            return true;
